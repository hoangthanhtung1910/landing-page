...
import { TrustPointsService } from './trust-points.service';

@Controller('content/trust-points')
@UseGuards(AdminGuard, CsrfGuard)
export class TrustPointsController {
  constructor(@Inject(TrustPointsService) private readonly service: TrustPointsService) {}
